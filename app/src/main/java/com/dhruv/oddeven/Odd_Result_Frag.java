...
public class Odd_Result_Frag extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View v =  inflater.inflate(R.layout.fragment_odd__result_, container, false);
       // mScrollView = (ObservableScrollView) v.findViewById(R.id.odd_scrollView);
        mRecyclerView = (RecyclerView) v.findViewById(R.id.odd_recyclerView);
    ...
    public class MyAdapter extends RecyclerView.Adapter<MyAdapter.MyViewHolder> {
            ...
            public MyViewHolder(View itemView) {
                ...
                v.setOnClickListener(new View.OnClickListener() {
                    ...
                    public void onClick(View v) {
                        //Toast.makeText(getActivity().getApplicationContext(),"HELLO ID: "+ id,Toast.LENGTH_SHORT).show();
        ...
        public void onBindViewHolder(MyViewHolder holder, int position) {
            ...
            //holder.gcm_regid = current_person.g

...
public class Received_rides extends Fragment {

    RecyclerView mRecyclerView;
    RecyclerView.LayoutManager mLayoutManager;
    public RecyclerView.Adapter mAdapter;
    public static List<History_List> received_list = new ArrayList<History_List>();

    public Received_rides() {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View v = inflater.inflate(R.layout.fragment_received_rides, container, false);
        mRecyclerView = (RecyclerView) v.findViewById(R.id.recyclerView_received);
        ...
        new AsyncTask<Void, Void, Void>() {
            ...
            protected Void doInBackground(Void... params) {
                DownloadHistory.downloadData("received");
                return null;
            }
            ...
            protected void onPostExecute(Void aVoid) {
                ...
                mAdapter = new RecyclerViewMaterialAdapter(new MyAdapter(getActivity().getApplicationContext(), received_list));
    ...
    public class MyAdapter extends RecyclerView.Adapter<MyAdapter.MyViewHolder> {
        ...
        public void onBindViewHolder(MyViewHolder holder, int position) {
            ...
            holder.from_name_tv.setText(current_person.getFrom_name());
            ...
            DownloadHistory.getIdfromEmail(context,current_person.getFrom_id(),holder.person_image);
